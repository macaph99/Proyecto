...
public class Vehiculo {
    ...
    public static void venderVehiculo(int codigo, String nombre, String apellido, int documento, HashMap<Integer, Vehiculo> inventario, HashMap<Integer, Venta> ventas) {
